...
@interface FSLocationAtHomeVC () <UITextFieldDelegate>

@property (nonatomic, strong) UITextField *nameTF;

@end

@implementation FSLocationAtHomeVC
...
- (void)refreshInterface
{
    ...
    if (self.selectedObjectID) {
        ...
        [cdh.context existingObjectWithID:self.selectedObjectID
                                    error:nil];
        
        self.nameTF.text = locationAtHome.storedIn;
    }
}
...
- (void)textFieldDidBeginEditing:(UITextField *)textField
{
    ...
    if (textField == self.nameTF) {
        locationAtHome.storedIn = self.nameTF.text;
